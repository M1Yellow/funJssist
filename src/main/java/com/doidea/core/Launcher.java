 ...
 * <br>
 * java -javaagent:doidea-1.0.0-jar-with-dependencies.jar Test
 * <br>
 * 有打印日志和配置参数，说明插件可以运行，Test 不存在不用管
 * <br>
 * >>>> agentArgs: null <br>
 * >>>> getJarURI path: /E:/DevRes/doidea-1.0.0-jar-with-dependencies.jar <br>
 * >>>> jarURI.getPath(): /E:/DevRes/doidea-1.0.0-jar-with-dependencies.jar <br>
...
public class Launcher {
    ...
    public static void premain(String args, Instrumentation inst) {
        ...
        try {
            ...
            // TODO jar 包类文件加入到 BootstrapClassLoader，以便可以在要修改的代码中直接调用自定义类方法
